...
/**
 * @description Calgary Demo font title component
 ...
 * @returns {JSX.Element}
 */
const CalgaryDemoTitle = ({title, style = "", textStyle = ''}) => {
    /**
    ...
    /**
     * @description Render Calgary Demo Title in Text Component
     */
    return (
...
export default CalgaryDemoTitle;